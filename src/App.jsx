...
const clientID = `?client_id=iTZElsPEREDljhnDmNGvkbC3cbH3lUI9E8luLdzVDBA`;
    ...
    <Router>
      <div>
        <nav className="navbar">
          <div className="navbar__logo">Pixie-Pop</div>
                    ...
                    {photos.map((image, index) => {
                      ...
                      return (
                        <Photos
                          ...
                          isFavorite={true} 
                        >
                          {isFavorite ? <span>Added to Favorites</span> : 
                          (<p>No Favorites Photos added yet</p>)}
                        </Photos>
                      );
                    })}
                  </div>
